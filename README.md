...
打开 `assets/js/main.js`，在 `POSTS` 数组中添加新文章的元数据（id、title、date、category、tags、excerpt、file）。
...
- **修改博客名称**：编辑 `index.html`、`post.html`、`about.html` 中的 `<title>` 和 `.site-title`
- **修改分类**：编辑 `assets/js/main.js` 中的 `CATEGORIES` 数组
- **修改配色**：编辑 `assets/css/style.css` 顶部的 `:root` CSS 变量
